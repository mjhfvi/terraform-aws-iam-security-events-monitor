# Lambda Function for iam_event_monitor
...
# resource "aws_lambda_function" "rag_db_query" {
#   description   = "lambda function to handle RAG queries"
#   filename      = data.archive_file.iam_event_monitor.output_path
#   function_name = "rag_db_query"
#   role          = aws_iam_role.lambda_logs_events_role.arn
#   runtime       = var.lambda_runtime
...
# # CloudWatch Logs for RAG Queries
# resource "aws_cloudwatch_log_group" "lambda_function_log_group" {
#   name              = "/aws/lambda/${aws_lambda_function.rag_db_query.function_name}"
#   retention_in_days = var.lambda_function_log_retention_days
# }
