...
output "opensearch_domain_name" {
  ...
  # value = length(aws_opensearch_domain.cloudtrail_logs) > 0 ? aws_opensearch_domain.cloudtrail_logs[0].id : null
  # precondition {
  #   condition     = var.enable_opensearch == false
  #   error_message = "set enable_opensearch to true"
  # }
}
